...
public class SupplierMapper {
    public static Supplier mapToEntity(SupplierDto supplierDto){
        Supplier supplier=Supplier.builder().companyName(supplierDto.getCompanyName())
    ...
    public static SupplierDto mapToDto(Supplier supplier){
        SupplierDto supplierDto=SupplierDto.builder().companyName(supplier.getCompanyName())
